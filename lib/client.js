...
/* Panel appears/disappears with a fade+slide transition instead of a hard
   display toggle, and the conversation column glides to its new margin. */
...
body[data-pair-panel-mode='abg'] [class*='centerCol'] { transition: margin-right .32s cubic-bezier(.22,.78,.2,1); }
body:not([data-pair-panel-mode]) [class*='centerCol'], body[data-pair-panel-mode='plain'] [class*='centerCol'] { transition: margin-right .32s cubic-bezier(.22,.78,.2,1); }
